...
{
    public static class CascadingDropDownListExtensions
    {
        /// <summary>
    ...
    if (document.readyState != 'loading') {{
        ...
        public static MvcHtmlString CascadingDropDownList<TModel>(
            ...
            SourceCallBackOptions options = null)
        {
            ...
            scriptBuilder.AppendFormat(Js1CreateInitFunction, inputId, triggeredByProperty, selectedValue, 
                removeDisabledString, optionLblStr, setDisableString, ajaxUri,
