...
namespace Mvc.Controls
{
    ...
    if (document.readyState != 'loading') {{
        ...
        public static MvcHtmlString CheckBoxListCustom<TModel>(
        ...
        public static MvcHtmlString CheckBoxListCustom(
            ...
            SourceCallBackOptions options = null)
        {
            ...
            scriptBuilder.AppendFormat(Js1CreateInitFunction, inputId, selectedValue, optionLblStr, ajaxUri,
